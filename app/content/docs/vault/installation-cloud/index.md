...
If you plan to run Vault in a different cluster (which is perfectly possible), you will need to make sure you complete the initial setup of the [Factory installation](/docs/enterprise/installation). To be more specific you will need to have following components running:
