...
In a few seconds you will see how many recordings were generated during a certain time period, which Agents were involved, and the classifications predicted by a machine learning service.

### Signed urls

Once you're inside the Kerberos Hub application, you will see all available recordings of your Agents in a single interface. So how does this work? We already know that Kerberos Vault is involved, but there something else happening as well.
...
Kerberos Hub allows you to visualise live streams from your Agents. A low and high resolution is made available.
...
You can structure your cameras across groups and sites. By creating sites, sub accounts get restricted access to specific cameras or groups of cameras. By grouping Agents it is easier to filter recordings.

{{< figure src="hub-sites.gif" alt="Using sites and groups you can structure your Agents. " caption="Using sites and groups you can structure your Agents." class="stretch">}}
